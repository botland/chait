...
void build_assistant_tool_call(cJSON *messages, ToolResponseParams *params) {
    ...
    cJSON_AddStringToObject(tool_call, "id", strdup(params->tool_call_id));
    cJSON_AddStringToObject(tool_call, "type", "function");

    cJSON *function = cJSON_CreateObject();
    cJSON_AddStringToObject(function, "name", strdup(params->tool_name));
    cJSON_AddStringToObject(function, "arguments", strdup(params->tool_arguments ? params->tool_arguments : "{}"));
...
void build_tool_response(cJSON *messages, ToolResponseParams *params) {
    if (params->content != NULL) {
        ...
        cJSON_AddStringToObject(msg, "content", strdup(params->content ? params->content : ""));
        cJSON_AddStringToObject(msg, "tool_call_id", strdup(params->tool_call_id));
        cJSON_AddStringToObject(msg, "name", strdup(params->tool_name));
        cJSON_AddItemToArray(messages, msg);
